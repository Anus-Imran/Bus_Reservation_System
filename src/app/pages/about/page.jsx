        ...
        >
          ...
          <div className="relative w-full h-screen z-10 ">
            <div className="w-full  mb-[120px]">
              <Image src={logo} alt="logo" className="rounded-[50%] h-[100px] w-[100px] m-[10px]" />
            </div>
            ...
            <p className="text-xl sm:text-2xl mb-8 max-w-2xl mx-auto">
              ...
              <Link className="text-black text-[20px] font-bold underline ml-[10px]" href="#">Read more &rarr;</Link>
            </p>
              ...
              {questions.map((item, index) => {
                return (
                  <AccordionItem key={index} value={String(index)}>
                    <AccordionTrigger className="p-[10px] text-xl border-2 border-gray-300 w-[50vw] mb-[10px] no-underline">
                      {item.question}
                    </AccordionTrigger>
                    <AccordionContent className="p-[10px] text-[16px] w-[50vw] mb-[10px]">
                      {item.answer}
                    </AccordionContent>
                  </AccordionItem>
                );
