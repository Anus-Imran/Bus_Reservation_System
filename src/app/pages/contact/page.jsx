...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-blue-500 to-green-400 py-10">
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-3xl shadow-xl border border-gray-300">
